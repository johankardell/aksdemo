// Main Bicep template for AKS with HAProxy Ingress Controller
// This template creates a VNet with AKS subnet, deploys an AKS cluster with workload profile,
// and sets up infrastructure for HAProxy ingress controller to expose NGINX
...
param baseName string = 'copilothaproxy'
...
// Deploy VNet with subnet for AKS
...
// Deploy AKS cluster with workload profile enabled
