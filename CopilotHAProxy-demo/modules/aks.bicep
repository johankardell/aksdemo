// AKS cluster module with workload profile enabled
// Creates an AKS cluster with VNet injection, workload identity, and auto-scaler profile
...
// AKS cluster with workload profile enabled
resource aksCluster 'Microsoft.ContainerService/managedClusters@2024-09-01' = {
  name: name
  location: location
  tags: {
    Environment: environmentName
    Purpose: 'AKS cluster with HAProxy ingress and workload profile'
  }
  identity: {
    type: 'UserAssigned'
  ...
  properties: {
    ...
    // Workload profile enabled features
    securityProfile: {
      workloadIdentity: {
        enabled: true
      }
